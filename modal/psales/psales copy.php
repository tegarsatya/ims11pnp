        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="bank" class="form-control" placeholder="Type here..." required="required" />
                </div>
                <div class="form-group col-md-6">
                    <label>Nomor Rekening <span class="tx-danger">*</span></label>
                    <input type="text" name="norek" class="form-control" placeholder="Type here..." required="required" />
                </div>
			</div>
            <div class="row">
                <div class="form-group col-md-6">
