            ...
            <div class="form-group col-md-12">
				<div class="table-responsive">
					<table id="example1" class="tabelgetdata">
						...
						?>
							<tr onClick="<?php echo("showProductTransfer('$nomor', '$hsl->id_psd', '$hsl->id_pro', '$hsl->nama_pro', '$hsl->kode_pro', '$hsl->harga_phg', '$hsl->berat_pro', '$hsl->nama_kpr', '$hsl->satuan_kpr', '$hsl->nama_spr', '$hsl->no_bcode', '$hsl->tgl_expired', '$hsl->sisa_psd')"); ?>">
