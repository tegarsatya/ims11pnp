<?php
	...
	switch($act){
		case "update":
			...
			$edit->execute();
			//SAVE
			$edit	= $conn->prepare("UPDATE produk_stokdetail SET no_bcode=:bcode, tgl_expired=:tglexp, masuk_psd=:masuk, keluar_psd=:keluar, sisa_psd=:sisa, updated_at=:catat, updated_by=:admin WHERE id_psd=:kode");
