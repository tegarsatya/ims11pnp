<?php
	...
	$read	= $conn->prepare("SELECT sj_tfk, id_out, pajak_tfk, kode_tfk FROM transaksi_faktur_c WHERE id_tfk=:code");
...
<div class="content-header">
    <div>
        ...
        <div class="form-check">
            <input onchange="taxStatusChange()" class="form-check-input" value="P" type="radio" name="taxStatus" id="flexRadioDefault1" <?=$p?> >
            <label class="form-check-label" for="flexRadioDefault1">
               <strong> P - Include Pajak (FAKTUR D) </strong>
            </label>
        </div>
        <div class="form-check">
            <input onchange="taxStatusChange()" class="form-check-input" value="NP" type="radio" name="taxStatus" id="flexRadioDefault2" <?=$np?>>
            <label class="form-check-label" for="flexRadioDefault2">
               <strong> NP - Exclude Pajak (FAKTUR C)</strong>
            </label>
        </div>
    </div>
</div>
            ...
            <div class="col-sm-12">
                ...
                <table class="tabeltransaksi">
                    ...
                    <tbody id="dataaddsales">
                    	<tr id="pilihoutlet"><td colspan="10">Pilih P / NP Terlebih Dahulu...</td></tr>
					</tbody>
                    <tfoot>
                    	<tr>
