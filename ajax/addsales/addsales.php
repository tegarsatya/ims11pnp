<?php
	...
	$taxStatus	= $secu->injection(@$_GET['taxStatus']);
	$nomor	= ($jumlah + 1);
?>
<tr id="<?php echo("traddsales$nomor"); ?>">
    <td>
    <a href="#modal1" onclick="<?php echo("addsales($nomor, 'outlet', '$taxStatus')"); ?>" data-toggle="modal">
	...
	<td><input type="text" name="jumlah[]" id="<?php echo("pjumlah$nomor"); ?>" class="inputangka" value="1" onchange="<?php echo("jumlahsales($nomor,'$taxStatus')"); ?>" onkeyup="angka(this)" placeholder="0" /></td>
	...
	<td><input type="text" name="diskon[]" id="<?php echo("pdiskon$nomor"); ?>" class="inputangka" value="<?php echo($diskon); ?>" onchange="<?php echo("hitungsales($nomor,'$taxStatus')"); ?>" placeholder="0" readonly="readonly" /></td>
